...
check_file="output-adjoint-dynamic-topography-volume-term-smoke/adjoint_finite_difference_checks_rank_00000.txt"
if [[ ! -f "${check_file}" ]]; then
  check_file="output-adjoint_dynamic_topography_volume_term_smoke/adjoint_finite_difference_checks_rank_00000.txt"
fi
